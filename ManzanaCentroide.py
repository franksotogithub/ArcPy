...
arcpy.env.workspace = r"Database Connections/Prueba6.sde/prueba.DBO.base_urbana"
...
if arcpy.Exists ("sprueba.DBO.manzana_censal_centroide")==False:
...
for row in arcpy.da.SearchCursor("sprueba.DBO.manzana_censal_centroide", ["SHAPE@"]):
    rowArray = []
