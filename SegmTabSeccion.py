...
def EnumerarSecciones(ubigeos):
    ...
    MARCOS_AEUS = "D:/ShapesPruebasSegmentacionUrbanaTabular/AEU/Mapas/TB_MARCOS_AEUS.shp"

    arcpy.Sort_management("D:/ShapesPruebasSegmentacionUrbanaTabular/AEU/EnumerarAEUViviendas/MZS_AEU.dbf", MZS_AEU_TEMP,
...
def CrearMarcosSecciones():
    arcpy.env.overwriteOutput = True
    MARCOS_AEUS = "D:/ShapesPruebasSegmentacionUrbanaTabular/AEU/Mapas/TB_MARCOS_AEUS.shp"
    MARCOS_SECCIONES = "D:/ShapesPruebasSegmentacionUrbanaTabular/SECCIONES/Mapas/TB_MARCOS_SECCIONES.shp"
...
def CrearSecciones(ubigeos):
    ...
    arcpy.MakeFeatureLayer_management(AEUS_LINEAS,
                                      "aeus")
    ...
    for row1 in arcpy.da.SearchCursor(ZONA_SECCION, ["UBIGEO", "ZONA", "SECCION","SUM_SUM_CANT_VIV","CODCCPP"], where_expression):
        ...
        out_feature = "D:/ShapesPruebasSegmentacionUrbanaTabular/SECCIONES/Mapas/Dissolve/" + str(row1[0]) + str(row1[1]) + str(row1[2]) + ".shp"
        ...
        calculate_expression3 = int(row1[2])
        calculate_expression4 = int(row1[3])
