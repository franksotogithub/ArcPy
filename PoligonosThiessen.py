...
arcpy.CreateThiessenPolygons_analysis("sprueba.DBO.manzana_censal_centroide", r"Database Connections/Prueba6.sde/sprueba.DBO.base_urbana/sprueba.DBO.manzana_censal_poligonos_Voronoi", "ALL")